...
public interface MybatisStoreDAO {
    ...
    @Insert("insert into t_feed_detail (feed_id,feed_code,title) values (#{feedDetail.feedId},#{feedDetail.feedCode},#{feedDetail.title})")
    int saveFeedDetail(@Param("feedDetail")FeedDetail feedDetail);
}
