...
public class TimeConfigPage extends JFrame{
	...
	public TimeConfigPage(){
		...
		ViewUtil.makeLabel(this, "休息方式", gridbag, c,0,0);
		...
		ViewUtil.makeComboBox(this, cbx, gridbag, c,1,0);

		ViewUtil.makeLabel(this, "工作时间", gridbag, c,0,1);
		final JTextField workTime = (JTextField)ViewUtil.makeTextField(this, String.valueOf(wTime), gridbag, c,1,1);

		ViewUtil.makeLabel(this, "休息时间", gridbag, c,0,2);
		final JTextField restTime = (JTextField)ViewUtil.makeTextField(this, String.valueOf(rTime), gridbag, c,1,2);

		JButton saveButton = (JButton)ViewUtil.makebutton(this, "保存", gridbag, c,1,3);
